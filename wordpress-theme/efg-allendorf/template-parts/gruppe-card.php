...
if ( in_array( $card_slug, array( 'gottesdienst', 'glv', 'bibelstunde', 'hauskreise', 'kindergottesdienst', 'knallerbsen', 'wilde-fuechse', 'biblischer-unterricht', 'crossroad', 'kreisjugend', 'kaffee-und-muesli', 'frauengebetskreis', 'maennertreffen', 'seniorenarbeit' ), true ) ) {
